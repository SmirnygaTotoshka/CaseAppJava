...
public class PatientEditFactory extends DatabaseEditFactory{
    ...
    public Parent create() {
        ...
        TextField sirname = new TextField();
        ...
        telephone.setText(patient == null ? "" : patient.getTelephone());

        Button passport = new Button(patient == null ? "Добавить" : patient.getPassport());
        ...
        Button police = new Button(patient == null ? "Добавить" : patient.getPolice());
        ...
        ChoiceBox<Reference> sex = new ChoiceBox<>(domen_sex);
        ...
        ChoiceBox<Reference> priviledge = new ChoiceBox<>(domen_priviledge);
        priviledge.setValue(patient == null ? priviledge.getItems().get(0) : GlobalResources.findItemFromReference(domen_priviledge, patient.getPriviledge()));
        ...
        ChoiceBox<Reference> employment = new ChoiceBox<>(domen_employment);
        ...
        ChoiceBox<Reference> family_status = new ChoiceBox<>(domen_family_status);
        ...
        DatePicker dob = new DatePicker(patient == null ? LocalDate.now().minusYears(18) : patient.getDob().toLocalDate());
